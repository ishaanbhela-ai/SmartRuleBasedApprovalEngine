...
ActiveRecord::Schema[8.1].define(version: 2026_02_06_052227) do
  ...
  create_table "request_types", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["tenant_id", "name"], name: "index_request_types_on_tenant_id_name_active_unique", unique: true, where: "(deleted_at IS NULL)"
  ...
  create_table "rules", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["request_type_id", "grade"], name: "index_rules_on_request_type_grade_active_unique", unique: true, where: "(deleted_at IS NULL)"
